...
var editProduct = function (product) { return __awaiter(void 0, void 0, void 0, function () {
    var foundProduct;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, product_model_1.Product.findOne({ _id: product._id })];
            case 1:
                foundProduct = _a.sent();
                if (!foundProduct) {
                    return [2, getError_1.getError(400, "Product could not be found")];
                }
                return [4, product_model_1.Product.updateOne({ _id: product._id }, __assign(__assign({}, product), { updatedAt: new Date() }))
